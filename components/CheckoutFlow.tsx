    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-agri-50 to-forest-50 p-8">
        <div className="max-w-2xl mx-auto">
          <div className="bg-earth-900 rounded-2xl shadow-2xl overflow-hidden">
            {/* Success Header */}
            <div className="bg-gradient-to-r from-agri-600 to-forest-600 p-8 text-white text-center">
              <div className="bg-earth-900/20 backdrop-blur-sm w-20 h-20 rounded-full flex items-center justify-center mx-auto mb-4">
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-agri-50 to-forest-50 p-4 md:p-8">
      <div className="max-w-7xl mx-auto">
        {/* Header */}
        <div className="bg-earth-900 rounded-xl shadow-lg p-6 mb-6">
          <button
            onClick={onBack}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2">
            <div className="bg-earth-900 rounded-xl shadow-lg p-6">
                      ...
                      <button
                        ...
                        className={`p-4 border-2 rounded-lg transition-all ${
                          accountType === 'business'
                            ...
                            : 'border-earth-700 hover:border-agri-300'
                        }`}
                      >
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                          ...
                          <input
                            ...
                            className="w-full px-4 py-3 border border-earth-700 rounded-lg focus:ring-2 focus:ring-agri-500 focus:border-transparent"
          ...
          <div className="lg:col-span-1">
            <div className="bg-earth-900 rounded-xl shadow-lg p-6 sticky top-6">
              ...
              <div className="space-y-3 mb-6 max-h-64 overflow-y-auto">
                {items.map((item) => (
                  <div key={item.id} className="flex gap-3 pb-3 border-b border-earth-700">
                    <div className="bg-earth-900 rounded p-2 w-12 h-12 flex items-center justify-center flex-shrink-0">
