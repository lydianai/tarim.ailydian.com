...
import { Globe, TrendingUp, Award, Zap, Cpu } from 'lucide-react';
    ...
    <div className="space-y-6">
      ...
      <div className="bg-gradient-to-br from-earth-900 to-earth-800 rounded-xl p-6 shadow-lg border border-earth-700">
        <div className="flex items-center gap-3 mb-4">
          ...
          <div>
            <h2 className="text-2xl font-bold text-white">Global Agricultural Technology Comparison</h2>
            <p className="text-sm text-white">Compare leading countries in agricultural innovation and productivity</p>
          </div>
        </div>

        {/* Country Selection */}
        <div className="mb-4">
          <h3 className="text-sm font-semibold text-white mb-2">Select Countries (max 4):</h3>
              ...
              <button
                ...
                className={`px-4 py-2 rounded-lg font-semibold text-sm transition-all ${
                  selectedCountries.includes(country.code)
                    ...
                    : 'bg-earth-800 text-white hover:bg-earth-700 border border-earth-600 disabled:opacity-50 disabled:cursor-not-allowed'
                }`}
              >
        ...
        {/* Metric Selection */}
        <div>
          <h3 className="text-sm font-semibold text-white mb-2">Comparison Metric:</h3>
      ...
      <div className="bg-gradient-to-br from-earth-900 to-earth-800 rounded-xl p-6 shadow-lg border border-earth-700">
        <h3 className="text-xl font-bold text-white mb-4">Technology Adoption Rates</h3>
        <ResponsiveContainer width="100%" height={400}>
          ...
          <div key={country.code} className="bg-gradient-to-br from-earth-900 to-earth-800 rounded-xl p-6 shadow-lg border border-earth-700 border-t-4" style={{ borderTopColor: colors[idx] }}>
            <div className="flex items-center justify-between mb-4">
              <div>
                ...
                <p className="text-sm text-white">Rank #{country.rank} Globally</p>
              </div>
            ...
            <div className="space-y-3">
              <div className="bg-earth-800/50 rounded-lg p-3 border border-earth-700">
                <div className="text-xs text-white mb-1">Key Technologies</div>
              ...
              <div className="grid grid-cols-2 gap-2 text-center">
                <div className="bg-green-900/30 rounded p-2 border border-green-700">
                  ...
                  <div className="text-xs text-white">Innovation</div>
                </div>
                <div className="bg-blue-900/30 rounded p-2 border border-blue-700">
                  ...
                  <div className="text-xs text-white">Water Eff.</div>
                </div>
              </div>

              <div className="space-y-1 text-sm">
                <div className="flex justify-between">
                  <span className="text-white">Agri GDP:</span>
                  <span className="font-semibold text-white">${country.agriculturalGDP}B</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-white">Exports:</span>
                  <span className="font-semibold text-white">${country.exportValue}B</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-white">R&D Investment:</span>
                  <span className="font-semibold text-white">${country.rdInvestment}B/yr</span>
                </div>
              </div>

              <div className="pt-3 border-t border-earth-700">
                <div className="text-xs font-semibold text-white mb-2">Key Achievements:</div>
      ...
      <div className="bg-gradient-to-r from-blue-900/30 to-indigo-900/30 rounded-xl p-6 shadow-lg border border-blue-700">
        <div className="flex items-center gap-3 mb-4">
          ...
          <h3 className="text-xl font-bold text-white">Insights for US Agriculture</h3>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div className="bg-earth-800/50 rounded-lg p-4 border border-earth-700">
            <div className="text-sm font-semibold text-white mb-2">🇳🇱 Learn from Netherlands</div>
          ...
          <div className="bg-earth-800/50 rounded-lg p-4 border border-earth-700">
            <div className="text-sm font-semibold text-white mb-2">🇮🇱 Learn from Israel</div>
            <ul className="text-xs text-white space-y-1">
          ...
          <div className="bg-earth-800/50 rounded-lg p-4 border border-earth-700">
            <div className="text-sm font-semibold text-white mb-2">🇯🇵 Learn from Japan</div>
            <ul className="text-xs text-white space-y-1">
