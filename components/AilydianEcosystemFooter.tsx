...
export default function AilydianEcosystemFooter({
  currentDomain,
  position: _position = 'above-footer',
  theme = 'dark'
    ...
    >
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-8">
          ...
          <p className={`mt-2 text-sm ${theme === 'dark' ? 'text-gray-400' : 'text-gray-400'}`}>
          ...
          {otherDomains.map((domain, index) => (
            ...
            >
              ...
              <div className="relative z-10">
                ...
                {/* Short Description */}
                <p className={`text-xs text-center ${theme === 'dark' ? 'text-gray-400' : 'text-gray-400'}`}>
                  {domain.shortDesc}
                </p>
              </div>
