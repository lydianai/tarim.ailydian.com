        ...
        {insights.map((insight, idx) => (
          <div
            ...
            className={`relative overflow-hidden rounded-xl p-6 cursor-pointer transition-all duration-300 ${
              selectedInsight === idx
                ? 'bg-earth-900 shadow-2xl scale-105 ring-2 ring-purple-500'
                : 'bg-earth-900 shadow-lg hover:shadow-xl'
            }`}
          >
            {/* Gradient Background */}
            ...
            <div className="relative">
              <div className="flex items-start justify-between mb-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h3 className="font-bold text-earth-100 text-lg">{insight.title}</h3>
                    <p className="text-sm text-earth-300 mt-1">{insight.description}</p>
                  </div>
                </div>
              </div>
              ...
              <div className="grid grid-cols-3 gap-3 mb-4">
                <div className="bg-earth-900 rounded-lg p-3 text-center">
                  <div className="text-xs text-earth-300 mb-1">Current</div>
                  <div className="font-bold text-earth-100">{insight.metrics.current}</div>
                </div>
                <div className="bg-earth-900 rounded-lg p-3 text-center">
                  <div className="text-xs text-earth-300 mb-1">Potential</div>
                  <div className="font-bold text-earth-100">{insight.metrics.potential}</div>
                </div>
              ...
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center gap-2">
                  <div className="text-xs text-earth-300">AI Confidence:</div>
      ...
      <div className="bg-gradient-to-r from-indigo-600 to-purple-600 rounded-xl p-6 shadow-2xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          {[
            ...
            <div key={item.step} className="bg-earth-900/10 backdrop-blur-sm rounded-lg p-4 border border-white/20">
              <div className="flex items-center gap-2 mb-2">
                <div className="w-8 h-8 rounded-full bg-earth-900/20 flex items-center justify-center text-white font-bold">
                  {item.step}
                </div>
