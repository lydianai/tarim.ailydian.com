  ...
  return (
    <div className="space-y-12">
      ...
      <div className="bg-gradient-to-br from-purple-600 via-indigo-600 to-violet-700 rounded-2xl p-10 shadow-2xl text-white relative overflow-hidden">
        <div className="absolute top-0 right-0 w-96 h-96 bg-earth-900/5 rounded-full blur-3xl"></div>
        ...
        <div className="relative z-10">
          ...
          <div className="bg-earth-900/10 backdrop-blur-sm rounded-xl p-6 border border-white/20 mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            {[
              ...
              <div key={idx} className="bg-earth-900/10 backdrop-blur-sm rounded-xl p-5 border border-white/20 hover:bg-earth-900/20 transition-all duration-300">
      ...
      {/* PROBLEM STATEMENT */}
      <div className="bg-earth-900 rounded-2xl p-10 shadow-xl border border-purple-100">
        <div className="flex items-center gap-4 mb-8">
      ...
      <div className="bg-gradient-to-br from-purple-50 to-indigo-50 rounded-2xl p-10 shadow-xl border-2 border-purple-200">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
          {[
            ...
            <div key={idx} className="bg-earth-900 rounded-xl p-6 border-2 border-purple-300 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
        ...
        <div className="bg-gradient-to-r from-purple-600 to-indigo-600 rounded-xl p-6 text-white">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {[
              ...
              <div key={idx} className="bg-earth-900/20 backdrop-blur-sm rounded-lg p-4 text-center">
          ...
          <div>
            ...
            <div className="space-y-3">
              {[
                ...
                <div key={idx} className="bg-earth-900 rounded-lg p-4 border-2 border-purple-300 hover:shadow-md transition-shadow">
      ...
      <div className="bg-gradient-to-br from-purple-600 via-indigo-600 to-violet-700 rounded-2xl p-10 shadow-2xl text-white">
        ...
        <div className="mb-8">
          <h3 className="text-3xl font-bold mb-6 flex items-center gap-2">
            <span className="bg-earth-900/20 px-3 py-1 rounded-lg">2025</span>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            {[
              ...
              <div key={idx} className="bg-earth-900/10 backdrop-blur-sm rounded-xl p-5 border border-white/20 hover:bg-earth-900/20 transition-all">
        ...
        <div className="mb-8">
          <h3 className="text-3xl font-bold mb-6 flex items-center gap-2">
            <span className="bg-earth-900/20 px-3 py-1 rounded-lg">2026</span>
        ...
        <div>
          <h3 className="text-3xl font-bold mb-6 flex items-center gap-2">
            <span className="bg-earth-900/20 px-3 py-1 rounded-lg">2027</span>
      ...
      <div className="bg-gradient-to-br from-purple-600 via-indigo-600 to-violet-700 rounded-2xl p-10 shadow-2xl text-white">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
          ...
          <div>
            ...
            <div className="space-y-4">
              {useOfFunds.map((item, idx) => (
                <div key={idx} className="bg-earth-900/10 backdrop-blur-sm rounded-lg p-5 border border-white/20 hover:bg-earth-900/15 transition-all">
                  <div className="flex items-center justify-between mb-3">
                    <span className="font-bold text-lg">{item.category}</span>
                    <span className="text-3xl font-bold">{item.amount}%</span>
                  </div>
                  <div className="w-full bg-earth-900/20 rounded-full h-3 mb-3">
                    <div
          ...
          <div>
            ...
            <div className="space-y-4 mb-6">
              <div className="bg-earth-900/10 backdrop-blur-sm rounded-xl p-5 border border-white/20">
                <div className="flex items-center justify-between mb-3">
        ...
        {/* 12-Month Milestones */}
        <div className="bg-earth-900/10 backdrop-blur-sm rounded-xl p-6 border border-white/20">
      ...
      <div className="bg-gradient-to-br from-gray-800 to-gray-900 rounded-2xl p-10 shadow-2xl text-white border-2 border-gray-700">
        <div className="flex items-center gap-4 mb-8">
          <div className="bg-earth-900/10 backdrop-blur-sm p-4 rounded-xl">
        ...
        <div className="space-y-6">
          {/* SEC Regulation D */}
          <div className="bg-earth-900/5 backdrop-blur-sm rounded-xl p-6 border border-white/10">
      ...
      <div className="bg-gradient-to-br from-purple-600 via-indigo-600 to-violet-700 rounded-2xl p-10 shadow-2xl text-white text-center relative overflow-hidden">
        ...
        <div className="relative z-10">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-6 mb-8">
            <div className="bg-earth-900/20 backdrop-blur-sm rounded-xl px-8 py-4 border border-white/30 hover:bg-earth-900/30 transition-all">
