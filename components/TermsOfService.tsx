    ...
    <div className="space-y-8">
      ...
      <div className="bg-earth-900 rounded-xl p-8 shadow-lg">
        ...
        <div className="space-y-4">
          <div className="bg-gradient-to-r from-purple-50 to-pink-50 rounded-xl p-6 border border-purple-200">
            <h3 className="font-bold text-white mb-3 text-lg">Account Creation</h3>
          ...
          <div className="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-xl p-6 border border-blue-200">
            <h3 className="font-bold text-white mb-3 text-lg">Account Security</h3>
            <p className="text-white mb-3">You are responsible for:</p>
            <ul className="space-y-2 text-white">
              <li className="flex items-start gap-2">
      ...
      <div className="bg-earth-900 rounded-xl p-8 shadow-lg">
        <div className="flex items-center gap-3 mb-6">
          ...
          <h2 className="text-3xl font-bold text-white">3. Acceptable Use</h2>
        </div>
      ...
      <div className="bg-earth-900 rounded-xl p-8 shadow-lg">
        ...
        <div className="space-y-4">
          <div className="bg-gradient-to-r from-blue-50 to-cyan-50 rounded-xl p-6 border border-blue-200">
            <h3 className="font-bold text-white mb-3 text-lg">Subscription Plans</h3>
